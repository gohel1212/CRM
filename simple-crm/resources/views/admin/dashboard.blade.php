...
@section('content')
    ...
    <div class="mb-8">
        ...
        <p class="mt-2 text-lg text-gray-600 dark:text-gray-300">Welcome back, {{ auth()->user()->name }}! Here's what's
            happening with your CRM system.</p>
    </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border border-gray-200 dark:border-gray-700">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900 dark:text-white">{{ $audit_stats['logs_today'] ?? 0 }}</p>
                </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border border-gray-200 dark:border-gray-700">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900 dark:text-white">{{ $audit_stats['logs_this_week'] ?? 0 }}
                    </p>
                </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border border-gray-200 dark:border-gray-700">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900 dark:text-white">{{ $audit_stats['failed_logins'] ?? 0 }}</p>
                </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border border-gray-200 dark:border-gray-700">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900 dark:text-white">{{ $user_stats['active_users'] ?? 0 }}</p>
                </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900 dark:text-white">
                        ₹{{ number_format($revenue_stats['total_revenue'] ?? 0) }}</p>
                </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border border-gray-200 dark:border-gray-700">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm font-medium text-gray-600 dark:text-gray-400">Total Deals</p>
                    <p class="text-2xl font-bold text-gray-900 dark:text-white">{{ $deal_stats['total_deals'] ?? 0 }}</p>
                </div>
            ...
            <div class="p-6 border-b border-gray-200 dark:border-gray-700">
                <div class="flex items-center justify-between">
                    ...
                    <a href="{{ route('admin.audit-logs.index') }}"
                        class="text-sm text-indigo-600 dark:text-indigo-400 hover:text-indigo-500 dark:hover:text-indigo-300">View
                        all</a>
                </div>
            </div>
            <!-- <div class="p-6">
                        <div class="space-y-4">
                            ...
                            <div class="flex items-center space-x-3">
                                <div class="w-2 h-2 bg-green-400 rounded-full"></div>
                                    ...
                                    <p class="text-sm text-gray-900 dark:text-white">{{ $log->description ?? 'System activity' }}</p>
        ...
        <div class="p-6">
            <div class="grid grid-cols-2 gap-4">
                ...
                <a href="{{ route('admin.monitor.index') }}"
                    class="flex items-center p-4 bg-gray-50 dark:bg-gray-700 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors">
                    <div
                        class="w-10 h-10 bg-yellow-100 dark:bg-yellow-900 rounded-lg flex items-center justify-center mr-3">
                    ...
                    <div>
                        <p class="text-sm font-medium text-gray-900 dark:text-white">Monitor</p>
