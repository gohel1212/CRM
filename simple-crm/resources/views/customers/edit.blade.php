    ...
    <div class="md:grid md:grid-cols-3 md:gap-6">
        <div class="md:col-span-1">
            <div class="px-4 sm:px-0">
                <h3 class="text-lg font-medium leading-6 text-gray-900 dark:text-gray-100">Edit Customer</h3>
                <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                    Update the customer's details below. Fields marked with * are required.
                </p>
            </div>
        </div>
                ...
                <div class="shadow sm:rounded-md sm:overflow-hidden">
                    <div class="px-4 py-5 bg-white dark:bg-gray-800 space-y-6 sm:p-6">
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <textarea id="description" name="description" rows="3"
                                    ...
                                    placeholder="Add any additional notes about this customer">{{ old('description', $customer->description) }}</textarea>
                            </div>
                            @error('description')
                                <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <select id="status" name="status" required
                                class="mt-1 block w-full py-2 px-3 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 dark:text-gray-100 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm @error('status') border-red-500 @enderror">
                                    @php($status = old('status', $customer->status))
                        ...
                        <div class="px-4 py-3 bg-gray-50 dark:bg-gray-700 text-right sm:px-6">
                            ...
                            <button type="submit"
                                class="ml-3 inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Update Customer</button>
                        </div>
                    </div>
                </form>
            </div>
